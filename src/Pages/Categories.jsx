  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <span className="text-xs text-gray-400 dark:text-gray-500">{categories.length} categories</span>
      </div>

      {categories.length === 0 ? (
        <div className="flex h-[40vh] items-center justify-center">
          <p className="text-gray-400 dark:text-gray-500">No categories found.</p>
        </div>
      ) : (
